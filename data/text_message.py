...
class text_1():
    ...
    t_become_1 = "Хорошо! У нас новый водитель!"
    t_become_2 = "Заполни заявку по ссылке ниже:"
...
Перейдя в раздел "Создать поездку", ты сможешь найти попутчиков."""
    t_set_driver = "Хотите стать водителем? Для этого необходимо заполнить форму в вашем профиле."
...
class text_3():
    ...
    t_payTheTrip = "Вам будут доступны контакты попутчика после оплаты. Стоимость поездки 200 рублей" #DDD
